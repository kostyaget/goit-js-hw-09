...
const btnStart = document.querySelector('button[dta-start]');
...
const fr = flatpickr(dateSelector, options);
btnStart.addEventListener('ckick', onStartClick);
...
function checkDate() {
    if (currentTime >= selectedTime) {
        ...
        Notiflix.Notify.succes('Correct date was set. click Start to degin countdown.');
    }
}
